#!/usr/bin/python3>
"""Define unit test for models/square.py.
Unittest classes:
...
class TestSquare_instantiation(unittest.TestCase):
    """Unit test for testing instantiation of the Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Unit test for testing size initialization of the Square class."""
...
class TestSquare_x(unittest.TestCase):
    """Unit test for testing initialization of Square x attribute."""
...
class TestSquare_y(unittest.TestCase):
    """Unit test for testing initialization of Square y attribute."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unit test for testing order of Square attribute initialization."""
...
class TestSquare_area(unittest.TestCase):
    """Unit test for testing the area method of the Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unit test for testing __str__ and display methods of Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """Detect and returns text printed to stdout.
        Args:
...
class TestSquare_update_args(unittest.TestCase):
    """Unit test for testing update args method of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unit test for testing update kwargs method of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unit test for testing to_dictionary method of the Square class."""
