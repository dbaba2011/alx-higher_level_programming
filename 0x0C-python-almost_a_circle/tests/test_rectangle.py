#!/usr/bin/python3
"""Define unit test for models/rectangle.py.
Unittest classes:
...
class TestRectangle_width(unittest.TestCase):
    """Unit test for testing initialization of Rectangle width attribute."""
...
class TestRectangle_height(unittest.TestCase):
    """Unit test for testing initialization of Rectangle height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """Unit test for testing initialization of Rectangle x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Unit test for testing initialization of Rectangle y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unit test for testing Rectangle order of attribute initialization."""
...
class TestRectangle_area(unittest.TestCase):
    """Unit tess for testing the area method of the Rectangle class."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unit test for testing __str__ and display methods of Rectangle class."""
...
class TestRectangle_update_args(unittest.TestCase):
    """Unit test for testing update args method of the Rectangle class."""
